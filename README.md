...
`scrape_pbp.py` will scrape the play-by-play data for each season from 2015 (or a provided first season to use) to the most recent **fully complete** NFL season.
